...
function Address() {
  const data = {
    ...
    address:
      "Junta de Freguesia de Oiã<br />R. Tuna Oianense, Nº 22<br />3770-059 Oiã",
  ...
  return (
    <>
      ...
      <DataItem>
        <IoPrintSharp /> {data.fax}
      </DataItem>
      <DataItem>
        <small>(<sup>*</sup> chamada rede fixa nacional)</small>
      </DataItem>
      <Spacer />
      <DataItem>
        <IoTimeOutline />
        <div>
          ...
          <br />
          <RenderHtml value={data.schedule} />
        </div>
      </DataItem>
    </>
  );
